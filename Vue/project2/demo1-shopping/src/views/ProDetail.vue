<template>
    <div class="prodetail">
      ...
      <van-swipe :autoplay="3000" @change="onChange">
        <van-swipe-item v-for="item in goods_details.goods_images" :key="item.goods_id">
          <img :src="item.external_url" />
        </van-swipe-item>
  
        <template #indicator>
          <div class="custom-indicator">{{ current + 1 }} / {{ goods_details.goods_images.length }}</div>
        </template>
      </van-swipe>
      ...
      <div class="info">
        <div class="title">
          <div class="price">
            <span class="now">￥{{goods_details.goods_price_min}}</span>
            <span class="oldprice">￥{{goods_details.line_price_min}}</span>
          </div>
      ...
      <div class="comment">
        ...
        <div class="comment-list">
          <div class="comment-item" v-for="item in this.comment_short" :key="item.comment_id">
            <div class="top">
      ...
      <!-- 商品描述 -->
      <div class="desc">
        <img v-for="item in goods_details.goods_images" :key="item.goods_id"
        :src="item.external_url" alt="">
...
<!--购物车或者立刻购买-->
    ...
    <div class="product-title">
      ...
      <div class="right">
        <div class="price">
          <span>¥</span>
          <span class="nowprice">{{goods_details.goods_price_min}}</span>
        </div>
        <div class="count">
          <span>库存</span>
